...
$method = $_SERVER['REQUEST_METHOD'];
    ...
    $sql = "call edit_producto('$id','$idTienda', '$descripcion', '$precio','$nombre', '$img1', '$img2', '$img3');";
    $sql2 = "delete from categorias_productos_pendientes where id = '$id';";
    ...
    for($i= 0; $i<count($categorias); $i++){
      ...
      $sql3="Insert into categorias_productos_pendientes (id_categoria, id_producto) values ('$cat', '$id');";
